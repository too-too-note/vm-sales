        ...
        >
          <template v-slot:top>
            <v-toolbar
                flat
            >
              <v-toolbar-title>自販機リスト</v-toolbar-title>
              <v-spacer></v-spacer>
              <v-dialog
                  v-model="dialogEdit"
                  max-width="500px"
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        >
                          <v-text-field
                              v-model="editedItem.vendingMachineName"
                              label="自販機名"
                          ></v-text-field>
                        </v-col>
                        <v-col
                        ...
                        >
                          <v-text-field
                              v-model="editedItem.vendingMachineCode"
                              label="自販機コード"
                          ></v-text-field>
                        </v-col>
                        <v-col
              ...
              <v-dialog v-model="dialogDelete" max-width="500px">
                <v-card>
                  <v-card-title class="text-h5">自販機を削除します、よろしいですか?</v-card-title>
                  <v-card-actions>
                    <v-spacer></v-spacer>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: '手数料(固定)', value: 'feeFixed', align: 'end' },
  ...
  methods: {
    select() {
      ajax.post("vending-machine-list/select", this.form, (res) => {
    ...
    async deleteItemConfirm () {
      await ajax.post("vending-machine-list/delete", this.selectedItemByDelete)
    ...
    async save () {
      let url = this.editedIndex > -1 ? "vending-machine-list/update": "vending-machine-list/insert"
